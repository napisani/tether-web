export function Welcome({
  ...
  return (
    <div className="welcome">
      ...
      <p>
        {pairingAvailable
          ? "Unlock your iPhone, open Settings → Bluetooth, then scan from Tether. Your phone stays in control of the final confirmation."
...
export function Notice({ title, body }: { title: string; body: string }) {
  return <div className="notice warning"><span aria-hidden="true">!</span><div><h2>{title}</h2><p>{body}</p></div></div>;
}
